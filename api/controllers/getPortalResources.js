 ...
 */
module.exports = {
  getPortalResources: getPortalResources
};
 ...
 */
function getPortalResources(req, res) {
  // parameters/variables defined in the Swagger document can be referenced using:
  // req.swagger.params.{parameter_name}.value
  agolDataFaker.generateFakeDataForSchema('getPortalResources').then(function (fakeData) {
